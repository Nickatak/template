...
class TestNavigation:
    ...
    async def test_navigate_to_register_from_login(self, page, db_reset):
        ...
        await page.goto("http://localhost:3000/register", wait_until="domcontentloaded", timeout=5000)
    ...
    async def test_navigate_to_login_from_register(self, page, db_reset):
        ...
        await page.goto("http://localhost:3000/login", wait_until="domcontentloaded", timeout=5000)
    ...
    async def test_dashboard_accessibility(self, page, db_reset):
        ...
        await page.goto("http://localhost:3000/dashboard", wait_until="domcontentloaded", timeout=5000)
